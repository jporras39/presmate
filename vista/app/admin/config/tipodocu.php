...
<th class="text-center"><strong>Código de Tipo de Documento</strong></th>
<th class="text-center" colspan="3"><strong>Nombre de Tipo de Documento</strong></th>
</thead>
...
<thead class="bg-dark text-light">
<th class="text-center"><strong>Código de Tipo de Documento</strong></th>
<th class="text-center"><strong>Nombre de Tipo de Documento</strong></th>
</thead>
<tbody class="bg-light">
<td class="text-center" colspan="2">No se encontraron Tipos de Documentos Registradas</td>
</tbody>
</table>
';
//echo $tvacio;
$codigo=$_POST['codiTiDo'];
$nombre=$_POST['nombTiDo'];
...
if (isset($_POST['tdi'])) { 
  ...
  $q=$con->real_escape_string($_POST['tdi']);
  $sql="SELECT * FROM TipoDocu where NombTiDo like '%".$q."%'";
  $eje=$con->query($sql);
  if ($eje->num_rows >0) {
