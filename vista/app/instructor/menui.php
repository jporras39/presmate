...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
 ...
 <div class="collapse navbar-collapse" id="navbarText">
   ...
   <ul class="navbar-nav mr-auto">
     <h4 class="text-center text-light"><strong>Sistema para el control de materiales de formación - Instructor</strong></h4>
   </ul>
   <div class="col">
   </div>
     ...
     <ul class="navbar-nav mr-auto">
       ...
       <li class="nav-item dropdown">
         <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="oi oi-person"></span>
           <?php echo "Instructor Conectado" ?>
         </a>
         <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
           <a class="dropdown-item" href="#"><span class="oi oi-monitor"></span> Cuenta</a>
           <a class="dropdown-item" href="../../index.php"><span class="oi oi-power-standby"></span> Cerrar Sesión</a>
         </div>
       </li>
     </ul>
   </span>
